...
association_numbers_df = pd.read_csv('./data/B-datasets/DrugDiseaseAssociationNumber.csv', header=0)
...
final_reordered.to_csv('./data/original_samples/Association.csv', index=False)
print(f"A total of {len(final_reordered)} associated drug-disease pairs have been generated.")
