...
if __name__ == '__main__':
    ...
    MODEL_NAME = "TextRCNN"
    RESULTS_BASE_PATH = r"./data/results/{MODEL_NAME}"
    data_paths = [
        # r"。/data/undersample/ClusterCentroids.csv",
        # r"。/data/undersample/KSU_Euclidean.csv",
        # r"。/data/undersample/NeighbourhoodCleaningRule.csv",
        # r"。/data/undersample/NearMiss.csv",
        # r"。/data/undersample/OneSidedSelection.csv",
        # r"。/data/undersample/RandomUnderSampler.csv",
    ...
    for data_path in data_paths:
        ...
        print(f" {data_path} successfully processed\n")
