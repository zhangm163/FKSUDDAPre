...
datasets = [
    {
        ...
        "output_dir": r"./data/results/SVM/",
        "results_file": r"./data/results/SVM/SVM_KSU_Hamming.csv"
    }
    #add more
]
...
model = LinearSVC(random_state=42, max_iter=1000, dual=False, tol=1e-4)
...
for dataset in datasets:
    ...
    for fold, (train_index, test_index) in enumerate(kf.split(X, y), 1):
        ...
        grid_search = GridSearchCV(LinearSVC(random_state=42, max_iter=1000, dual=False, tol=1e-4), param_grid, cv=5,
